...
- fix(tower): upgrade path tints now actually visible — strength ramp T1=0.55 / T2=0.80 / T3=1.00 (was capped at 0.60 at T3 → near-white at every tier). Closes playtest-feedback #47.
